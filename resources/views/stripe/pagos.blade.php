...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <form  action="{{route('payStripe')}}"  data-cc-on-file="false" data-stripe-publishable-key="pk_test_gsQNMTguJLdYgr3cR1h26mpF" name="frmStripe" id="frmstripe" method="post">
                {{ csrf_field() }}
                <div class="row">
